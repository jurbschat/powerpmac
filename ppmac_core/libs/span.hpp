...
#define TCB_SPAN_NAMESPACE_NAME stdext
#endif
...
struct tuple_size<TCB_SPAN_NAMESPACE_NAME::span<E, S>> : public integral_constant<size_t, S> {};

template <typename E>
struct tuple_size<TCB_SPAN_NAMESPACE_NAME::span<E, TCB_SPAN_NAMESPACE_NAME::dynamic_extent>>; // not defined

template <size_t N, typename E, ptrdiff_t S>
struct tuple_element<N, TCB_SPAN_NAMESPACE_NAME::span<E, S>> {
    using type = E;
};
